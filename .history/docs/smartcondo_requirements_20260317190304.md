...
1. **Definição:** O "Pai do integrante" (Cliente) pede algo.
2. **Refinamento:** O grupo discute: "Dá para fazer?", "Como fica o banco de dados para isso?".
3. **Documentação:** Atualiza o arquivo de requisitos e o DER.
4. **Desenvolvimento:** Alguém assume a tarefa no Trello e codifica no GitHub.
5. **Review/Demo:** Mostram para o cliente (ou para o integrante que entende mais do negócio) para validar.
...
| **Erros/Bugs encontrados** | Aba de "Issues" no GitHub. |
